---
layout: default
title: "Plano Museológico"
permalink: /museudememes/plano-museologico/
  ...
  <div class="container pt-10 pb-14 pt-md-14 pb-md-17 text-center">
    <div class="row">
      <div class="col-lg-9 col-xxl-8 mx-auto">
        <h1 class="display-1 mb-3">Plano <span class="underline-3 style-1 primary"><em>Museológico</em></span></h1>
        <p class="lead fs-lg px-md-12">O documento institucional que orienta todas as ações do #MUSEUdeMEMES — da política de acervo à gestão e sustentabilidade.</p>
      </div>
    </div>
  </div>
</section>
