...
tema: ""
ano_origem: "2018"
formato: "Vídeo viral, parodia,"
criador: "Desconhecido"
plataforma: "Reddit, x, instagram"
palavras_chaves:
  - "instagram"
  - "facebook"
  - "twitter"
...
Memes de captcha são aqueles que usam imagens ou captchas como humor. Normalmente, captchas pedem para identificar objetos específicos em um conjunto de imagens para provar que o usuário não é um robô, e os memes brincam com essa ideia, explorando o quanto captchas podem ser absurdos, confusos ou frustrantes. Montagens de captchas com perguntas absurdas ou filosoficamente complexas, tipo “selecione onde está o seu propósito na vida". Memes onde, por exemplo, uma cena do cotidiano é cheia de objetos que poderiam “enganar" o captcha, como uma rua cheia de placas de trânsito e o captcha pergunta “selecione todas as imagens que contêm placas”.
...
Grande parte dos memes de captcha é apresentada no formato de imagens com texto sobreposto. Frequentemente, usam capturas de tela de captchas reais ou simulados, com ou sem legendas que adicionam humor, ironia ou exagero ao conceito. Essa simplicidade visual permite que o meme seja compreendido rapidamente.

Captchas muitas vezes parecem tão complicados que os memes sobre eles se encaixam bem no humor absurdista. Esse é o caso de memes que mostram desafios impossíveis de resolver ou que questionam a existência (tipo “clique nas imagens onde está o sentido da vida"). Esses memes se relacionam com o tipo de humor que vem da irritação ou frustração compartilhada. Assim como memes sobre filas longas ou atendimento automático, os memes de captcha capturam a experiência quase cômica da dificuldade em algo aparentemente simples.
